...
program
  ...
  .option("--verbose", "Verbose mode: print opencode output to console (default: output to log file only)")
  .option("--log-file <path>", "Log file path (default: auto-code-bot-detail.log in project dir)")
